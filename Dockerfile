...
# Ghidra
RUN curl -L https://github.com/NationalSecurityAgency/ghidra/releases/download/Ghidra_10.2.2_build/ghidra_10.2.2_PUBLIC_20221115.zip -o ghidra.zip && \
    unzip ghidra.zip -d "${HOME}/.local/opt" && \
    rm ghidra.zip
ENV GHIDRA_INSTALL_DIR="${HOME}/.local/opt/ghidra_10.2.2_PUBLIC"
