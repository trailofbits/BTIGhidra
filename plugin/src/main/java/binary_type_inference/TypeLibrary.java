...
public class TypeLibrary {
  ...
  private TypeLibrary(
      CTypeMapping mapping, Map<String, DataType> type_constants, DataType unknownType) {
    this.mapping = mapping;
  ...
  private DataType build_structure(Structure struct, int node_index) {
    ...
    Collections.sort(
        flds, (Field f1, Field f2) -> Integer.compare(f1.getByteOffset(), f2.getByteOffset()));
  ...
  public static TypeLibrary parseFromInputStream(
      InputStream target, Map<String, DataType> type_constants, DataType unknownType)
      throws IOException {
